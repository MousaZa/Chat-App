    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          Expanded(
            child:StreamBuilder(
                stream: FirebaseFirestore.instance.collection('Conversations').doc(uid).collection('messages').orderBy('timestamp', descending: true).snapshots(),
            ...
            child: Row(
              ...
              children: [
                ...
                FloatingActionButton(
                  onPressed: () {
                    FirebaseFirestore.instance.collection('Conversations').doc(uid).collection('messages').add({
